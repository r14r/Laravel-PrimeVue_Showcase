<template>
    <DocSectionText v-bind="$attrs">
        <p>FloatLabel visually integrates a label with its form element. Visit <RouterLink to="/floatlabel">FloatLabel</RouterLink> documentation for more information.</p>
    </DocSectionText>
