<template>
    <DocSectionText v-bind="$attrs">
        <p>
            ...
            <RouterLink to="/virtualscroller">VirtualScroller</RouterLink> component is utilized so refer to the API of VirtualScroller for more information about the available options.
        </p>
