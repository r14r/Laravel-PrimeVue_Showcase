                ...
                components: [
                    {
                        ...
                        props: {
                            templateHeroData: {
                                ...
                                storeHref: 'https://primeui.store/templates/vue/genesis',
                                pattern: {
                    ...
                    },
                    {
                        ...
                        slots: {
                            ...
                            description4: `
                                ...
                                excluded from the Genesis Figma file as they are available in <RouterLink to="/uikit">PrimeOne for Figma</RouterLink> only.`
                        }
                    },
                    {
                        name: markRaw(TemplateFeatures),
